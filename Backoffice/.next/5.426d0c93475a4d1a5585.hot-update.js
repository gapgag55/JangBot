...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Wrapper__ = __webpack_require__("./components/Wrapper.jsx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__containers_HomeworkForm__ = __webpack_require__("./containers/HomeworkForm.jsx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__containers_TableItems__ = __webpack_require__("./containers/TableItems.jsx");
...
function (_Component) {
  ...
  function Home() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      enumerable: true,
      writable: true,
      value: function value(e, form) {
        e.preventDefault();
        var getHomework = _this.getHomework;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return __WEBPACK_IMPORTED_MODULE_7__utilities_request__["a" /* default */].post(__WEBPACK_IMPORTED_MODULE_8__config_api__["a" /* default */].url.homework, values);

                  case 4:
                    _ref3 = _context.sent;
                    statusCode = _ref3.statusCode;
                    message = statusCode == 200 ? 'Send Message: Success' : 'Send Message: Fail'; // notification.open({
                    //   message: message
                    // });
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 3;
                  return __WEBPACK_IMPORTED_MODULE_7__utilities_request__["a" /* default */].get(__WEBPACK_IMPORTED_MODULE_8__config_api__["a" /* default */].url.homework);
                ...
                case 3:
                  ...
                  if (statusCode) {
                    convertedData = data.map(function (item, key) {
                      ...
                      __WEBPACK_IMPORTED_MODULE_3_moment___default.a.locale('th');
                      return {
                        key: key,
                        subject: subject,
                        description: description,
                        type: type,
                        date: __WEBPACK_IMPORTED_MODULE_3_moment___default()(due_date).format('LL'),
                        time: __WEBPACK_IMPORTED_MODULE_3_moment___default()(due_time).format('LT'),
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_Wrapper__["a" /* default */], {
        __source: {
      ...
      }, __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__containers_HomeworkForm__["a" /* default */], {
        onSubmit: this.addHomework,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 89
        }
      }), __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__containers_TableItems__["a" /* default */], {
        isLoading: isLoading,
        data: data,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=5.426d0c93475a4d1a5585.hot-update.js.map