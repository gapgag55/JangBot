    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return __WEBPACK_IMPORTED_MODULE_8__utilities_request__["a" /* default */].update(__WEBPACK_IMPORTED_MODULE_9__config_api__["a" /* default */].url.homework, values.id, values);
      ...
      value: function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.mark(function _callee4(data) {
          var form, _id, subject, description, type, date, time, appointment;
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _id = data._id, subject = data.subject, description = data.description, type = data.type, date = data.date, time = data.time, appointment = data.appointment;
                  form.setFieldsValue({
                    id: _id,
                    subject: subject,
...
//# sourceMappingURL=5.134bbfee5b0d32c7c217.hot-update.js.map