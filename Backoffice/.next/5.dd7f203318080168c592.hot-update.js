      ...
      value: function value() {
        ...
        return [{
          ...
          render: function render(date) {
            console.log(__WEBPACK_IMPORTED_MODULE_4_moment___default()(date, 'YYYY/MM/DD'));
            return __WEBPACK_IMPORTED_MODULE_4_moment___default()(date, 'YYYY/MM/DD');
          }
        }, {
          title: 'เวลากำหนดส่ง',
          dataIndex: 'time',
          ...
          render: function render(time) {
            return __WEBPACK_IMPORTED_MODULE_4_moment___default()(time, 'h:mm:ss');
          }
        }, {
...
//# sourceMappingURL=5.dd7f203318080168c592.hot-update.js.map