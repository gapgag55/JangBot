            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  console.log(data.date, __WEBPACK_IMPORTED_MODULE_5_moment___default()(data.date, 'YYYY/MM/DD').format('LL'));
                  form.setFieldsValue({
                    id: data._id,
...
//# sourceMappingURL=5.fdb433302cdf0741348f.hot-update.js.map