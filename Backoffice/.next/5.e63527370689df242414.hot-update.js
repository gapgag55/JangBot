      ...
      value: function value() {
        ...
        return [{
          ...
          render: function render(data) {
            return __WEBPACK_IMPORTED_MODULE_4_moment___default()(data.date, 'YYYY/MM/DD');
          }
        }, {
          title: 'เวลากำหนดส่ง',
          dataIndex: 'time',
          key: 'time',
          render: function render(data) {
            return __WEBPACK_IMPORTED_MODULE_4_moment___default()(data.time).format('LT');
          }
        }, {
...
//# sourceMappingURL=5.e63527370689df242414.hot-update.js.map