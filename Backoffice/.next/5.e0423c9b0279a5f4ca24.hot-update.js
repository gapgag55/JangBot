            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  thaiTime = __WEBPACK_IMPORTED_MODULE_5_moment___default()(data.time).format('LT');
                  form.setFieldsValue({
                    id: data._id,
                    subject: data.subject,
                    description: data.description,
                    type: data.type,
                    date: __WEBPACK_IMPORTED_MODULE_5_moment___default()(data.date, 'YYYY/MM/DD'),
                    time: __WEBPACK_IMPORTED_MODULE_5_moment___default()(thaiTime, 'h:mm:ss'),
...
//# sourceMappingURL=5.e0423c9b0279a5f4ca24.hot-update.js.map