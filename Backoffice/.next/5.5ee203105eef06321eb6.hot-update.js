...
function (_Component) {
  ...
  function Home() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.mark(function _callee2() {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.mark(function _callee3(data) {
          var form, subject, description, type, date, time, appointment;
          return __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  form = _this.props.form;
                  subject = data.subject, description = data.description, type = data.type, date = data.date, time = data.time, appointment = data.appointment;
                  form.setFieldsValue({
                    subject: subject,
                    description: description,
                    type: type,
      ...
      value: function () {
        ...
        /*#__PURE__*/
        __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.mark(function _callee4(id) {
          ...
          return __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  _context4.next = 2;
                  return __WEBPACK_IMPORTED_MODULE_8__utilities_request__["a" /* default */].remove(__WEBPACK_IMPORTED_MODULE_9__config_api__["a" /* default */].url.homework, id);
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      console.log(data);
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_Wrapper__["a" /* default */], {
        __source: {
      ...
      }, __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__containers_HomeworkForm__["a" /* default */], {
        form: form,
      ...
      }), __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__containers_TableItems__["a" /* default */], {
        isLoading: isLoading,
        data: data,
        onEdit: this.onEdit,
...
//# sourceMappingURL=5.5ee203105eef06321eb6.hot-update.js.map