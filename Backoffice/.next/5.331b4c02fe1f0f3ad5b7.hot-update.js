            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  __WEBPACK_IMPORTED_MODULE_5_moment___default.a.locale('en');
                  console.log(__WEBPACK_IMPORTED_MODULE_5_moment___default()(data.date, 'YYYY/MM/DD').format('LL'));
                  form.setFieldsValue({
                    id: data._id,
                    subject: data.subject,
                    description: data.description,
                    type: data.type,
                    date: __WEBPACK_IMPORTED_MODULE_5_moment___default()(__WEBPACK_IMPORTED_MODULE_5_moment___default()(data.date, 'YYYY/MM/DD').format('LL'), 'YYYY/MM/DD'),
...
//# sourceMappingURL=5.331b4c02fe1f0f3ad5b7.hot-update.js.map